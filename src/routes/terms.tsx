...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The terms governing your use of Zenith." },
    ],
  }),
  component: TermsPage,
});
  ...
  return (
    <PublicLayout>
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <p className="mt-2 text-muted-foreground">Zenith is provided "as is". We don't guarantee job offers, response rates, or interview outcomes.</p>
