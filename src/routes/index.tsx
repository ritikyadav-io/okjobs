...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "OkJobs — Reach Your OkJobs" },
      ...
      { property: "og:description", content: "Reach Your OkJobs. AI-powered job discovery, ATS optimization, recruiter monitoring." },
    ],
  }),
  component: Landing,
});
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-24 pt-20 text-center md:pt-28">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl text-5xl font-extrabold leading-[1.05] tracking-tight md:text-7xl">
            Reach Your <span className="text-gradient-brand">OkJobs</span> 🚀
          </h1>
